...
const VERBS = [
  // ===== GEBEN =====
  {
    verb: 'geben', meta: 'gibt · gab · hat gegeben', meaning: 'მიცემა, გადაცემა', noun: 'die Gabe — საჩუქარი; ნიჭი', family: 'geben',
    examples: [
  ...
  {
    verb: 'abgeben', meta: 'gibt ab · gab ab · abgegeben', meaning: 'ჩაბარება; გადაცემა', noun: 'die Abgabe — გადასახადი; ჩაბარება', family: 'geben',
    examples: [
  ...
  {
    verb: 'angeben', meta: 'gibt an · gab an · angegeben', meaning: 'მითითება; ტრაბახი', noun: 'die Angabe — მითითება; der Angeber — ტრაბახა', family: 'geben',
    examples: [
  ...
  {
    verb: 'aufgeben', meta: 'gibt auf · gab auf · aufgegeben', meaning: 'მიტოვება; გაგზავნა; დავალების მიცემა', noun: 'die Aufgabe — დავალება; ამოცანა', family: 'geben',
    examples: [
  ...
  {
    verb: 'ausgeben', meta: 'gibt aus · gab aus · ausgegeben', meaning: 'დახარჯვა', noun: 'die Ausgabe — ხარჯი; გამოცემა', family: 'geben',
    examples: [
  ...
  {
    verb: 'bekanntgeben', meta: 'gibt bekannt · bekanntgegeben', meaning: 'გამოცხადება, გამოქვეყნება', noun: 'die Bekanntgabe — გამოცხადება; გამოქვეყნება', family: 'geben',
    examples: [
      { de: 'Der Trainer wird morgen die Aufstellung bekanntgeben.', ka: 'მწვრთნელი ხვალ გუნდის შემადგენლობას გამოაცხადებს.' },
    ]
  },
  {
    verb: 'durchgeben', meta: 'gibt durch · durchgegeben', meaning: 'სატელეფონოდ/სარადიოდ გადაცემა', noun: 'die Durchgabe — სარადიო/სატელეფონო შეტყობინება', family: 'geben',
    examples: [
      { de: 'Kannst du mir die genaue Uhrzeit durchgeben?', ka: 'შეგიძლია შეხვედრის ზუსტი დრო გადმომცე?' },
    ]
  },
  {
    verb: 'ergeben', meta: 'ergibt · ergab · ergeben', meaning: 'გამოდიოდეს; იძლეოდეს შედეგს', noun: 'das Ergebnis — შედეგი; მაჩვენებელი', family: 'geben',
    examples: [
  ...
  {
    verb: 'herausgeben', meta: 'gibt heraus · herausgegeben', meaning: 'გამოცემა; ხურდის დაბრუნება', noun: 'der Herausgeber — გამომცემელი; die Herausgabe — გამოცემა', family: 'geben',
    examples: [
  ...
  {
    verb: 'übergeben', meta: 'übergibt · übergab · übergeben', meaning: 'გადაბარება; ოფიციალური გადაცემა', noun: 'die Übergabe — გადაბარება; გადაცემა', family: 'geben',
    examples: [
      { de: 'Der alte Bürgermeister hat dem neuen die Amtsgeschäfte übergeben.', ka: 'ძველმა მერმა ახალს მოვალეობები გადასცა.' },
    ]
  },
  {
    verb: 'vergeben', meta: 'vergibt · vergab · vergeben', meaning: 'პატიება; ტენდერის გადაცემა', noun: 'die Vergabe — გადაცემა (ტენდერი); die Vergebung — პატიება', family: 'geben',
    examples: [
  ...
  {
    verb: 'weitergeben', meta: 'gibt weiter · weitergegeben', meaning: 'ინფორმაციის/ნივთის გადაცემა', noun: 'die Weitergabe — გადაცემა; გავრცელება', family: 'geben',
    examples: [
      { de: 'Bitte gib diese Information an alle Kollegen weiter.', ka: 'გთხოვ, ეს ინფორმაცია ყველა კოლეგას გადაეცი.' },
    ]
  },
  {
    verb: 'wiedergeben', meta: 'gibt wieder · wiedergegeben', meaning: 'შინაარსის გადმოცემა; რეპროდუქცია', noun: 'die Wiedergabe — გადმოცემა; ხარისხი (ჩანაწერი)', family: 'geben',
    examples: [
      { de: 'Kannst du kurz wiedergeben, was der Chef gesagt hat?', ka: 'შეგიძლია მოკლედ გადმოსცე, რა თქვა უფროსმა?' },
    ]
  },
  {
    verb: 'zugeben', meta: 'gibt zu · zugegeben', meaning: 'აღიარება; ნების დართვა', noun: 'die Zugabe — ბონუსი; ანქოური (კონცერტი)', family: 'geben',
    examples: [
      { de: 'Ich muss zugeben, dass ich mich geirrt habe.', ka: 'უნდა ვაღიარო, რომ შევცდი.' },
    ]
  },
  {
    verb: 'zurückgeben', meta: 'gibt zurück · zurückgegeben', meaning: 'უკან დაბრუნება', noun: 'die Rückgabe — უკან დაბრუნება; ჩაბარება', family: 'geben',
    examples: [
  ...
  // ===== GEHEN =====
  {
    verb: 'gehen', meta: 'geht · ging · ist gegangen', meaning: 'სიარული; წასვლა; შესაძლებლობა', noun: 'der Gang — სიარული; დერეფანი; სიჩქარე (მანქანა)', family: 'gehen',
    examples: [
  ...
  {
    verb: 'abgehen', meta: 'geht ab · ging ab · ist abgegangen', meaning: 'ჩამოვარდნა; მოწყვეტა; გამოქვითვა', noun: 'der Abgang — გამოსვლა; წასვლა (სცენიდან/სკოლიდან)', family: 'gehen',
    examples: [
  ...
  {
    verb: 'aufgehen', meta: 'geht auf · ging auf · ist aufgegangen', meaning: 'ამოსვლა (მზე); გახსნა; გაგება', noun: 'der Aufgang — ამოსვლა (მზე); კიბის უჯრედი', family: 'gehen',
    examples: [
  ...
  {
    verb: 'ausgehen', meta: 'geht aus · ging aus · ist ausgegangen', meaning: 'გასვლა; ჩაქრობა; დამთავრება; გამოლევა', noun: 'der Ausgang — გასასვლელი; შედეგი; საღამოს გასვლა', family: 'gehen',
    examples: [
  ...
  {
    verb: 'begehen', meta: 'begeht · beging · hat begangen', meaning: 'ჩადენა (დანაშაული/შეცდომა)', noun: 'die Begehung — ჩადენა; ადგილზე გასვლა (ინსპექცია)', family: 'gehen',
    examples: [
  ...
  {
    verb: 'durchgehen', meta: 'geht durch · ist durchgegangen', meaning: 'გადახედვა; გაშვება (შეცდომა)', noun: 'der Durchgang — გასასვლელი; რაუნდი; გავლა', family: 'gehen',
    examples: [
  ...
  {
    verb: 'eingehen', meta: 'geht ein · ging ein · ist eingegangen', meaning: 'გახმობა; გაკუმშვა; შემოსვლა', noun: 'der Eingang — შესასვლელი; შემოსვლა (წერილი/ფული)', family: 'gehen',
    examples: [
  ...
  {
    verb: 'spazieren gehen', meta: 'geht spazieren · ist spazieren gegangen', meaning: 'გასეირნება', noun: 'der Spaziergang — გასეირნება; სეირნობა', family: 'gehen',
    examples: [
  ...
  {
    verb: 'übergehen', meta: 'geht über · ist übergegangenis übergegangen', meaning: 'გადასვლა; გადაცემა (საკუთრება); ყურადღების ავლა', noun: 'der Übergang — გადასასვლელი; გარდამავალი პერიოდი', family: 'gehen',
    examples: [
  ...
  {
    verb: 'umgehen', meta: 'geht um · ist umgegangen', meaning: 'გავრცელება; მოპყრობა; თავის არიდება', noun: 'der Umgang — ურთიერთობა; მოპყრობა · die Umgehung — გვერდის ავლა', family: 'gehen',
    examples: [
  ...
  {
    verb: 'untergehen', meta: 'geht unter · ist untergegangen', meaning: 'ჩასვლა (მზე); ჩაძირვა; გაქრობა', noun: 'der Untergang — ჩასვლა (მზე); ჩაძირვა; კრახი', family: 'gehen',
    examples: [
  ...
  {
    verb: 'vergehen', meta: 'vergeht · verging · ist vergangen', meaning: 'გასვლა (დრო); გაქრობა (სურვილი)', noun: 'das Vergehen — დანაშაული; სამართალდარღვევა', family: 'gehen',
    examples: [
  ...
  {
    verb: 'vorangehen', meta: 'geht voran · ist vorangegangen', meaning: 'წინსვლა; წარმატება', noun: 'der Fortgang — პროგრესი; გაგრძელება; წასვლა', family: 'gehen',
    examples: [
  ...
  {
    verb: 'vorgehen', meta: 'geht vor · ist vorgegangen', meaning: 'წინ წასვლა; სისწრაფე (საათი); მოქმედება', noun: 'das Vorgehen — მოქმედების წესი · der Vorgang — პროცესი; საქმე', family: 'gehen',
    examples: [
  ...
  {
    verb: 'zugehen', meta: 'geht zu · ist zugegangen', meaning: 'დახურვა; მიახლოება', noun: 'der Zugang — შესასვლელი; წვდომა; მიდგომა', family: 'gehen',
    examples: [
  ...
  {
    verb: 'zurückgehen', meta: 'geht zurück · ist zurückgegangen', meaning: 'უკან დაბრუნება; შემცირება', noun: 'der Rückgang — შემცირება; ვარდნა; დაღმავლობა', family: 'gehen',
    examples: [
...
function renderList(filter) {
  ...
  items.forEach(v => {
    ...
    div.innerHTML = `
      ...
      <div class="vli-examples hidden">${exHtml}</div>
    `;
